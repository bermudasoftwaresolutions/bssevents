...
{
    /**
     * @var \Bermuda\BssShop\Domain\Model\OrderItem
     */
    ...
    {
        parent::setUp();
        $this->subject = new \Bermuda\BssShop\Domain\Model\OrderItem();
    }
     ...
     * @test
     */
    public function getBuildNameReturnsInitialValueForString()
    {
        self::assertSame(
            '',
            $this->subject->getBuildName()
        );
    }
     ...
     * @test
     */
    public function setBuildNameForStringSetsBuildName()
    {
        $this->subject->setBuildName('Conceived at T3CON10');
